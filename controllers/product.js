...
const createProduct = async (req,res) => {
    const {name,category:categoryName,quantity,price}= req.body
  try {
    ...
    const product = await Product.create({ name:name, category:categoryId, quantity:quantity, price:price })
